...
export const Appbar = () => {
  return (
    <header className="flex content-center justify-between p-4 border">
      ...
      <div className="flex items-center gap-4">
        <div className="flex content-center space-x-6 cursor-pointer">
          <WriteLogo /> Write
        </div>
        <img
          className="block w-11 h-11 rounded-full bg-gray-400 object-cover"
          src="./logo.svg"
        />
